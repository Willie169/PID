...
int main() {
    ...
    for (double maxIntTm = 0; maxIntTm <= 100000; maxIntTm++) {
        for (double maxAmp = 0; maxAmp <= 1000000; maxAmp += 0.1) {
            for (double minKp = 0; minKp <= 1000; minKp += 0.0001) {
                for (double maxKp = minKp; maxKp <= 1000; maxKp += 0.0001) {
                    for (double rTiM = 0; rTiM <= 1000; rTiM += 0.0001) {
                        for (double TdM = 0; TdM < 1000; TdM += 0.0001) {
                            for (double TddM = 0; TddM < 1000; TddM += 0.0001) {
                                for (double eDPm = 0; eDPm <= 10000000; eDPm++) {
                                    for (double eDPa = 0; eDPa <= 0.5; eDPa += 0.00001) {
                                        for (unsigned long session = 0; session < 1000000; session += 100) {
                                            for (double Kp = minKp; Kp <= maxKp; Kp += 0.0001) {
