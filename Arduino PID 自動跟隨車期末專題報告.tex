...
\hfill
\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/a1.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/a2.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/a3.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/a4.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/a5.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/a6.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/a7.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/a8.png}\end{figure}\FloatBarrier\end{center}
\subsection{工作截圖}
\begin{center}\begin{figure}[H]\centering
\hfill
\begin{minipage}[t]{0.45\textwidth}
...
\hfill
\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/c1.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/c2.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/c3.png}\end{figure}\FloatBarrier\end{center}
\begin{center}\begin{figure}[H]\centering\includegraphic[width=0.8\textwidth]{./model_images/c4.png}\end{figure}\FloatBarrier\end{center}
...
\phantomsection\addcontentsline{toc}{subsection}{車體設計}
\phantomsection\addcontentsline{toc}{subsection}{電路配置與接線}
\phantomsection\addcontentsline{toc}{subsection}{Arduino D1 WiFi 板測試}
\phantomsection\addcontentsline{toc}{subsection}{Arduino UNO R3 板測試}
\includepdf[pages=-,fitpaper=true]{./廖宏璿.pdf}
\subsection{零件與車體照片}
\begin{center}\begin{figure}[H]\centering
\hfill
\begin{minipage}[t]{0.45\textwidth}
...
\lstinputlisting[language=TeX]{./LaTeX-ToolKit/document.tex}
\subsubsection{Arduino PID 自動跟隨車期末專題報告}
\lstinputlisting[language=TeX]{./Arduino PID 自動跟隨車期末專題報告.tex}
\subsection{報告製作 C++ 輔助程式}
\sssc{CJKFontSettingsGen.cpp}
\lstinputlisting[language=C++]{./LaTeX-ToolKit/CJKFontSettingsGen.cpp}
\sssc{paragraph2itemize.cpp}
\lstinputlisting[language=C++]{./LaTeX-ToolKit/paragraph2itemize.cpp}
\subsection{3D 建模 STEP Code}
\lstinputlisting{./Assembly 1.step}
